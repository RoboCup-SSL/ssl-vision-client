...
// @generated from file gc/ssl_gc_referee_message.proto (syntax proto2)
 

import type { GenEnum, GenFile, GenMessage } from "@bufbuild/protobuf/codegenv1";
import { enumDesc, fileDesc, messageDesc } from "@bufbuild/protobuf/codegenv1";
import type { GameEvent, GameEventJson } from "./ssl_gc_game_event_pb";
import { file_gc_ssl_gc_game_event } from "./ssl_gc_game_event_pb";
import type { Message } from "@bufbuild/protobuf";

/**
 * Describes the file gc/ssl_gc_referee_message.proto.
 */
export const file_gc_ssl_gc_referee_message: GenFile = /*@__PURE__*/
  fileDesc("", [file_gc_ssl_gc_game_event]);
...
export type Referee = Message<"Referee"> & {
   ...
   * becomes negative.
   *
   * @generated from field: optional sint32 stage_time_left = 3;
   */
   ...
   *  * ball placement
   *
   * @generated from field: optional int32 current_action_time_remaining = 15;
   */
...
export const RefereeSchema: GenMessage<Referee, RefereeJson> = /*@__PURE__*/
  messageDesc(file_gc_ssl_gc_referee_message, 0);
...
export const Referee_TeamInfoSchema: GenMessage<Referee_TeamInfo, Referee_TeamInfoJson> = /*@__PURE__*/
  messageDesc(file_gc_ssl_gc_referee_message, 0, 0);
...
export const Referee_PointSchema: GenMessage<Referee_Point, Referee_PointJson> = /*@__PURE__*/
  messageDesc(file_gc_ssl_gc_referee_message, 0, 1);
...
export const Referee_StageSchema: GenEnum<Referee_Stage, Referee_StageJson> = /*@__PURE__*/
  enumDesc(file_gc_ssl_gc_referee_message, 0, 0);
...
export const Referee_CommandSchema: GenEnum<Referee_Command, Referee_CommandJson> = /*@__PURE__*/
  enumDesc(file_gc_ssl_gc_referee_message, 0, 1);
...
export type GameEventProposalGroup = Message<"GameEventProposalGroup"> & {
   ...
   *
   * @generated from field: repeated GameEvent game_event = 1;
   */
  gameEvent: GameEvent[];
...
export const GameEventProposalGroupSchema: GenMessage<GameEventProposalGroup, GameEventProposalGroupJson> = /*@__PURE__*/
  messageDesc(file_gc_ssl_gc_referee_message, 1);
...
export const MatchTypeSchema: GenEnum<MatchType, MatchTypeJson> = /*@__PURE__*/
  enumDesc(file_gc_ssl_gc_referee_message, 0);
